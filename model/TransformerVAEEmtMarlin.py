...
class TransformerVAEEmtMarlin(nn.Module):
    def __init__(self, img_size=224, audio_dim = 78, output_3dmm_dim = 58, output_emotion_dim = 25, feature_dim = 128, seq_len=750, max_seq_len=751, online = False, window_size = 8, device = 'cuda'):
        super(TransformerVAEEmtMarlin, self).__init__()
