...
def main(args):
    ...
    # val dataloader
    if args.render:
        val_loader = get_dataloader(args, "../data/val.csv", load_audio=False, load_video_s=load_video_s, load_emotion_s=True, load_emotion_l=True, load_3dmm_l=True, load_ref=True, load_video_orig=True, mode='val')
    else:
        val_loader = get_dataloader(args, "../data/val.csv", load_audio=False, load_video_s=load_video_s, load_emotion_s=True, load_emotion_l=True, load_3dmm_l=True, load_ref=False, load_video_orig=False, mode='val')
    ...
    seq_len = args.seq_len, max_seq_len=args.max_seq_len, online = args.online, window_size = args.window_size, device = args.device)
    if args.contrastive:
